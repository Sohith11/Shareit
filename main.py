...
def Send():
    ...
    def sender():
        ...
        conn.send(file_data)
        print("Data has been transmitted sucessful")
    ...
    Button(window,text="+ select file",width=10,height=1,font='aeial 14 bold',bg="#fff",fg="#000",command=select_file).place(x=160,y=150)
